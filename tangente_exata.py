...
t2 = [0, 4*pi, 4*pi*(0 + (202/4155)), 4*pi*(0 - (202/4155)), 4*pi*(1 + (202/4155)), 
4*pi*(1 - (202/4155)), 4*pi*(0 + (456/3677)), 4*pi*(0 - (456/3677)), 4*pi*(1 + (456/3677)), 
4*pi*(1 - (456/3677))]

for valor in t1:
    ponto = [(6 * cos(valor)) - (2 * cos(4.5*valor)), (6 * sin(valor)) - (2 * sin(4.5*valor))]
